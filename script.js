...
function mudarConteudo(idioma) {
  const traducoes = {
    pt: {
      ...
      about: "Sobre Mim",
      about_text: "Mestrando em ciências da computação pela UFS(Universidade Federal de Sergipe) com experiência como aluno de PIBIC, suporte de TI, desenvolvedor web/mobile e atualmente como desenvolvedor e analista de dados. Tenho experiência em desenvolvimento de aplicações web e mobile, além de aplicações com foco em análise de dados e machine learning. Sou apaixonado por tecnologia e sempre busco aprender novas habilidades para aprimorar meu trabalho. Estou sempre aberto a novos desafios e oportunidades de crescimento profissional.",
      expe: "Experiência",
    ...
    es: {
      ...
      about: "Sobre Mí",
      about_text: "Maestría en ciencias de la computación por la UFS (Universidad Federal de Sergipe) con experiencia como estudiante de PIBIC, soporte técnico, desarrollador web/móvil y actualmente como desarrollador y analista de datos. Tengo experiencia en el desarrollo de aplicaciones web y móviles, así como aplicaciones enfocadas en el análisis de datos y machine learning. Soy un apasionado de la tecnología y siempre busco aprender nuevas habilidades para mejorar mi trabajo. Siempre estoy abierto a nuevos desafíos y oportunidades de crecimiento profesional.",
      expe: "Experiencia",
    ...
    fr: {
      ...
      about_text: "Maîtrise en informatique de l'UFS (Université fédérale de Sergipe) avec une expérience en tant qu'étudiant PIBIC, support informatique, développeur web/mobile et actuellement développeur et analyste de données. J'ai de l'expérience dans le développement d'applications web et mobiles, ainsi que des applications axées sur l'analyse de données et le machine learning. Je suis passionné par la technologie et je cherche toujours à apprendre de nouvelles compétences pour améliorer mon travail. Je suis toujours ouvert à de nouveaux défis et opportunités de croissance professionnelle.",
      expe: "Expérience",
