...
function mudarConteudo(idioma) {
  const traducoes = {
    ...
    en: {
      ...
      about: "About Me",
      about_text: "Graduated in computer science from UFS (Federal University of Sergipe) with experience as a PIBIC student, IT support, web/mobile developer and currently as a developer and data analyst. I've worked with: Java | Python | Node.js | C | VM | Juice | Veins | Omnet++ | SQL | Git | AWS | Mendix | Foundry",
      expe: "Experience",
