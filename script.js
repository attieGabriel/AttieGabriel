function mudarConteudo() {
    if( document.getElementById("translate").innerHTML == "Translate to english"){
      ...
      document.getElementById("kitchen").innerHTML = "<a href=https://landing-cozinha-virtual.vercel.app/ target=_blank>Cozinha Virtual</a>: Social network for culinary lovers";
      document.getElementById("2d").innerHTML = "<a href=https://editor.p5js.org/gabrielgattie/full/oG3QlG-D9 target=_blank>2D Game</a>: Jumping and avoiding obstacles game";
      ...
      document.getElementById("kitchen").innerHTML = "<a href=https://landing-cozinha-virtual.vercel.app/ target=_blank>Cozinha Virtual</a>: Rede social para apaixonados pela culinária";
      document.getElementById("2d").innerHTML = "<a href=https://editor.p5js.org/gabrielgattie/full/oG3QlG-D9 target=_blank>Jogo 2D</a>: Jogo de pular e desviar de obstáculos";
